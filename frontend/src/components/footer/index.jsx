...
const Footer = () => {
  ...
  const leftColumns = [
    {
      ...
      items: [
        {
          content: <p className="max-w-xs">UNIT SISDA BBWS SUMATERA VIII</p>,
        },
        {
          content: (
            <div className="flex flex-row">
              <svg
                ...
                onClick={() => {
                  window.location.href =
                    "https://www.instagram.com/pupr_sda_sumatera8/";
                }}
              >
                <path
                  fill="#304ffe"
              ...
              <svg
                ...
                className="w-14 cursor-pointer"
                onClick={() => {
                  window.location.href = "https://www.facebook.com/bbwss8";
                }}
              >
                <path
                  fill="#3F51B5"
              ...
              <svg
                ...
                className="w-14 cursor-pointer"
                onClick={() => {
                  window.location.href = "https://x.com/bbwss8";
                }}
              >
                <path
                  fill="#212121"
              ...
              <svg
                ...
                onClick={() => {
                  window.location.href =
                    "https://www.youtube.com/@bbwssumateraviii4910/videos";
                }}
              >
                <path
                  fill="#FF3D00"
  ...
  const rightColumns = [
  {
    ...
    //     { content: <a href="#">Copyright Notice</a> },
    //   ],
    // },
  ];
  ...
  return (
    <footer className={styleFooter}>
      <div className="flex flex-col md:flex-row justify-around items-center md:items-start py-5 border-b-[1px]">
        <img
          src={logo}
          className="shadow-2xl w-24 h-24 md:w-36 md:h-36 mb-4 md:mb-0"
        />
        <div className="flex flex-col md:flex-row justify-start items-center md:items-start gap-5 mb-4 md:mb-0">
          {leftColumns.map((leftColumn, columnIndex) => (
            <div
              key={columnIndex}
              className="flex flex-col items-center md:items-start mx-4"
            >
        ...
        <div className="flex flex-col md:flex-row justify-end items-center md:items-start gap-5">
        ...
        {bottomColumns.map((bottomColumn, index) => (
          <div key={index} className="flex flex-col items-center">
            {bottomColumn.items.map((item, itemIndex) => (
              <div key={itemIndex} className="mb-2 text-center">
                {item.content}
              </div>
            ))}
          </div>
