    ...
    <div className="flex min-h-screen bg-gray-50 font-sans">
          ...
          {categories.map((cat) => {
            ...
            return (
              <button
                ...
                className={`w-full flex items-center gap-3 px-3 py-3 rounded-xl mb-1 text-left transition-all duration-200 group
                  ${isActive
      ...
      <main className="flex-1 px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-black text-[#0d2b45] tracking-tight uppercase">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          {filtered.map((satker) => {
            ...
            return (
              <div
                key={satker.id}
                className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm hover:shadow-md transition-all duration-200 hover:-translate-y-0.5 cursor-pointer group"
              >
                {/* Icon + Title */}
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <h3 className="text-base font-bold text-[#0d2b45] leading-snug pt-1">
                    {satker.name}
                  </h3>
                </div>
