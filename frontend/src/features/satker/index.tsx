...
const SIDEBAR_ITEMS = [
  { id: 1, label: "Satuan Kerja", icon: <Home size={16} />, alamat: "", phone: "" },
  { id: 2, label: "Satker OP Wilayah Sungai Musi", icon: <Map size={16} />, alamat: "Jl. Kapten Anwar Sastro no 3 Palembang 30113", phone: "(0711) 567890" },
  { id: 3, label: "Satker Pelaksanaan Jaringan SDA", icon: <Activity size={16} />, alamat: "Jl. Raya Kertapati no 123 Palembang 30113", phone: "(0711) 987654" },
  { id: 4, label: "Satker Irigasi dan Rawa Wil 1 Sumsel", icon: <Database size={16} />, alamat: "Jl. Diponegoro no 456 Palembang 30113", phone: "(0711) 456789" },
  { id: 5, label: "Satker Irigasi dan Rawa Wil 2 Sumsel", icon: <Phone size={16} />, alamat: "Jl. Sudirman no 789 Palembang 30113", phone: "(0711) 321654" },
];
